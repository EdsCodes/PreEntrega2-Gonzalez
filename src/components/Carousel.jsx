                ...
                <div className="col">
                    <div id="carouselExampleCaptions" className="carousel slide">
                        ...
                        <div className="carousel-inner">
                            <div className="carousel-item imgCarousel1 active">
                            ...
                            <div className="carousel-item">
                                <NavLink to={"/categoria/tablets & Pcs"}>
                            ...
                            <div className="carousel-item">
                                <NavLink to={"/categoria/audifonos"}>
                            ...
                            <div className="carousel-item">
                                <NavLink to={"/categoria/smartwatches"}>
                            ...
                            <div className="carousel-item">
                                <NavLink to={"/categoria/otros gadgets y accesorios"}>
